...
WORK = ROOT / "video" / "cold-wallet-trust"
SCENES = WORK / "scenes"
OUTPUT = WORK / "output"
SEGMENTS = WORK / "segments"
AUDIO = Path("/Users/juanpablogarcia/Downloads/everyone-says-cold-wallets-are.wav")
...
SENTENCES = [
    (0.275, 4.061, "Everyone says cold wallets are “unhackable” because they stay offline."),
    (4.443, 7.933, "But the recent Coldcard attack showed why that isn’t completely true."),
    (8.957, 12.674, "Coldcard devices generate a secret recovery phrase using randomness."),
    (13.037, 17.842, "Because of a firmware bug, some devices produced phrases with much less randomness than expected."),
    (18.282, 29.251, "Attackers could calculate possible phrases on their own computers, compare the resulting addresses with the public Bitcoin blockchain, and steal the funds—without ever connecting to or physically touching the wallets."),
    (30.232, 32.335, "The Bitcoin network itself wasn’t hacked."),
    (32.659, 36.641, "The weakness was in the device people trusted to generate their keys securely."),
    (37.608, 41.452, "And that’s the real lesson: you can reduce trust, but you can never eliminate it."),
    (41.830, 44.033, "With an exchange, you trust the exchange."),
    (44.936, 50.817, "With a hardware wallet, you trust its manufacturer, firmware, components—and your own security practices."),
    (51.770, 58.742, "The important question isn’t whether you trust someone. It’s who you trust, what you trust them with, and how you limit the damage if they fail."),
]
...
def main() -> None:
    ...
    silent_video = OUTPUT / "cold-wallet-trust-silent.mp4"
    ...
    final_video = OUTPUT / "Cold-Wallets-Are-Not-Unhackable.mp4"
