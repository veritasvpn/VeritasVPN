...
WORK = ROOT / "video" / "how-free-vpns"
SCENES = WORK / "scenes"
OUTPUT = WORK / "output"
SEGMENTS = WORK / "segments"
TRANSCRIPT_JSON = Path("/private/tmp/how-free-vpns-transcript.json")
AUDIO = Path("/Users/juanpablogarcia/Downloads/HowFreeVPNsMakeMoney.wav")

SCENE_CUTS = [0.0, 8.82, 21.62, 33.24, 41.46, 47.16, 64.92, 87.20, 98.175]
...
def render_caption_track(
    ...
    entry_index = 0
    for frame in range(math.ceil(98.175 * fps)):
        time = frame / fps
...
def main() -> None:
    ...
    for index, group in enumerate(groups, start=1):
        start = group[0]["start"]
        end = min(98.175, group[-1]["end"] + 0.08)
    ...
    silent_video = OUTPUT / "how-free-vpns-silent.mp4"
    ...
    final_video = OUTPUT / "How-Free-VPNs-Make-Money.mp4"
