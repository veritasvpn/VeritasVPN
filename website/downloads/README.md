...
| `veritasvpn-android.apk` | v0.2.17 signed Android release; streamed by `functions/downloads/veritasvpn-android.apk.js` from GitHub Releases (`v0.2.17`) |
| `veritasvpn-linux.deb` | v0.2.17 build; streamed by `functions/downloads/veritasvpn-linux.deb.js` from GitHub Releases (`v0.2.17`) |
| `veritasvpn-linux.AppImage` | v0.2.17 build; streamed by `functions/downloads/veritasvpn-linux.AppImage.js` from GitHub Releases (`v0.2.17`) |
