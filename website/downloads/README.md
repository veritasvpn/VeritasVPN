...
| `veritasvpn-android.apk` | v0.2.15 signed Android release; streamed by `functions/downloads/veritasvpn-android.apk.js` from GitHub Releases (`v0.2.15`) |
| `veritasvpn-linux.deb` | v0.2.15 build; streamed by `functions/downloads/veritasvpn-linux.deb.js` from GitHub Releases (`v0.2.15`) |
| `veritasvpn-linux.AppImage` | v0.2.15 build; streamed by `functions/downloads/veritasvpn-linux.AppImage.js` from GitHub Releases (`v0.2.15`) |
